...
// 		Execute(context.Context, int) ([]domain.ToolCategory, error)
// 	}
...
// func (t findAllToolCategoryInteractor) Execute(ctx context.Context, id int) ([]domain.ToolCategory, error) {
// 	ctx, cancel := context.WithTimeout(ctx, t.ctxTimeout)
// 	defer cancel()

// 	ToolCategory, err := t.repo.FindAllByAreaId(ctx, id)
// 	if err != nil {
